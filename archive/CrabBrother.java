...
@TeleOp(name="Crab Brother", group="Iterative1 OpMode")

public class CrabBrother extends OpMode
{
    ...
    public void loop() {
        if(gamepad1.a) {
            ...
            armServoPos = .6;
            armServo.setPosition(armServoPos);
            //(armServo.getPosition(), armServoPos);
            buttonPressed = true;
        } else if(gamepad1.y) {
            armServoPos = .45;
            armServo.setPosition(armServoPos);
        ...
        double tgtPower = gamepad2.left_stick_y;
